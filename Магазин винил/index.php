...
?>
    ...
    <div id="st"><img src="bas/admin/img/bas.png" alt=корзина border=0 align=middle>&nbsp;Ваша корзина пуста</div>
...
function win_bas()
  {    window.open('form.php?op=1','','width=750,height=450,status=no,toolbar=no,menubar=no,scrollbars=yes')
  }
     ...
     if(cookies.length>1)
       {
          ...
          document.getElementById("st").innerHTML="<img src=bas/admin/img/bas.png alt=корзина border=0 align=middle>&nbsp;<a href=javascript:win_bas();>товаров в корзине "+count+"</a> на сумму "+price+ " <?php echo $conf[8];  ?>";

       }
     else document.getElementById("st").innerHTML="<img src=bas/admin/img/bas.png alt=корзина border=0 align=middle>&nbsp;Ваша корзина пуста";
 }
