    ...
    for($x=$start,$y=0; $x<count($file); $x++,$y++)
     {
      ...
      if(@$_GET['red']==$expl[2])
       ...
       &lt;a class=\"i\" href=\"javascript:c('$expl[2]','$expl[1]')\" onClick=\"alert('Товар успешно добавлен в корзину')\">в корзину&lt;/a&gt;
       </td>
      <td id=sett2>
      ...
      else
      {
        ...
        &lt;a class=\"in\" href=\"javascript:c('$expl[2]','$expl[1]')\" onClick=\"alert('Товар успешно добавлен в корзину')\">в корзину&lt;/a&gt;
        </td>
        <td id=sett2>
